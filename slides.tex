...
\begin{frame}
	\titlepage
    \begin{center}
    Slides based on material by Pietro Berkes, Tiziano Zito, \\
    \href{http://pragprog.com/titles/tpp/the-pragmatic-programmer}{{\it The
    Pragmatic Programmer}} by Hunt and Thomas,\\
    and the \href{http://software-carpentry.org/}{Course on Software Carpentry} by Greg Wilson
    \end{center}
    \begin{figure}
