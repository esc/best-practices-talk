...
\date{Python Summer School Kiel, September 2012}
...
\begin{frame}
    \titlepage
    \begin{figure}
        \includegraphics[scale=0.4]{images/bbp_logo.pdf}
        \hspace{4em}
        \includegraphics[scale=0.4]{images/epfl_logo.pdf}
    \end{figure}
    \vspace{1em}
    \begin{center}
