...
\begin{frame}
	\titlepage
    \begin{center}
    Slides based on material by Pietro Berkes, Tiziano Zito and \\
    \href{http://pragprog.com/titles/tpp/the-pragmatic-programmer}{{\it The Pragmatic Programmer}} by Hunt and Thomas
    \end{center}
    \begin{figure}
